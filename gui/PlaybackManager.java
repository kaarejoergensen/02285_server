...
public class PlaybackManager
{
     ...
     * The actual FPS is determined in the constructor, namely based on the lowest refresh rate among the
     * display devices that we display to.
     * TODO: Consider providing a way to override tick rate? E.g. as an argument to the constructor?
     * <p>
    ...
    private void tick()
    {
        // TODO: Look into the tick time after domains do some real rendering.
        ...
        // TODO: Benchmark if the delegation to rendering threads actually gives an increase in speed.
        //       Possibly we should just do this on the EDT, at least for up to some number of domains in parallel.
        //       Particularly the synchronization is wasteful for a single domain being rendered, which is common.
        for (int i = 0; i < this.frames.length; ++i)
        {
